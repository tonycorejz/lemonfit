...
import instrucrorPhoto_2_1 from '../../../../public/img/instructors/nemkina-olesya/1.webp';
import instrucrorPhoto_2_2 from '../../../../public/img/instructors/nemkina-olesya/2.webp';
import instrucrorPhoto_2_3 from '../../../../public/img/instructors/nemkina-olesya/3.webp';
...
const nemkinaOlesya: Instructor = {
    id: 2,
    gallery: [instrucrorPhoto_2_2, instrucrorPhoto_2_1, instrucrorPhoto_2_3],
    name: 'Немкина Олеся',
    achievements: 'ПОМОГУ:\n\n✅создать красивое тело\n✅подтянуть проблемные места\n✅оптимизировать рацион питания \n✅укрепить свое тело и улучшить осанку\n✅обрести гибкость и свободу движений \n✅наполнить свой день энергией \n✅получить знания для эффективных и безопасных тренировок \n✅найти баланс между физическим и ментальным здоровьем \n\nЕсли тебе этого не хватает, то WELCOME 🤗\n⚡️стаж личных тренировок более 20 лет\n⚡️стаж работы в тренажерном зале - 7 лет\n⚡️образование: тренер тренажерного зала САФиБ\n⚡️инструктор групповых программ СК Иммер\n⚡️тренер пилатеса САБиФ',
    ...
    return (
        <div {...props} className={`w-full max-w-7xl flex flex-col items-center sm:justify-between justify-center p-6 lg:px-8 ${props.className}`}>
            ...
            <div className="w-full self-start grid gap-2 grid-cols-1 sm:grid-cols-2">
                ...
                <InstructorCard instructor={nemkinaOlesya}/>
            </div>
        </div>
    );
}