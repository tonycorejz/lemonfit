        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    {/* <DialogDescription>
                        Вы всегда можете перезвонить нам по номеру <Link href='tel:+73833803792'>+7 (383) 380‒37‒92</Link>
                    </DialogDescription> */}
                </DialogHeader>
                    <CallMeBackForm formSubmited={() => setOpen(false)}/>
                    <div className="flex flex-col">
                        <p className="text-sm mb-1">Вы всегда можете связаться с нами по номеру:</p>
                        <Link href='tel:+73833803792' className="text-sm font-bold ms-1 mb-2">+7 (383) 380‒37‒92</Link>
