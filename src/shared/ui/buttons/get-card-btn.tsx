...
export const GetCardButton: React.FC<Props> = ({children, href, ...props}) => {
    const className = `inline-flex items-center rounded-full px-4 sm:px-6 py-3 ring-2 ring-inset ring-[#24A746] shadow-[0_0_15px_2px_rgba(36,167,70,1)] hover:shadow-[0_0_15px_4px_rgba(36,167,70,1)] bg-gradient-to-r from-[#24A746] to-[#27C300] ${props.className}`;
